...
from passbert.backend import keras, K, is_tf_keras
from passbert.backend import sequence_masking
from passbert.backend import recompute_grad
...
if (not is_tf_keras) and keras.__version__ < '2.3':
    ...
    if keras.__version__ < '2.2.5':
        ...
        class Model(keras.models.Model):
            ...
            def fit(self, x=None, *args, **kwargs):
                print("Using changed Model: fit function")
    ...
    print("Do not use changed Model")
    class Layer(keras.layers.Layer):
        def __init__(self, **kwargs):
            super(Layer, self).__init__(**kwargs)
            self.supports_masking = True  # 本项目的自定义层均可mask
