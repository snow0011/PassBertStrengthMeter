...
from passbert.snippets import is_string, string_matching
from passbert.snippets import is_one_of, insert_arguments
from passbert.backend import piecewise_linear
import re
