...
cli.add_argument('-f', '--from-keras-ckpt', dest='from_keras', type=str, help='from keras ckpt-format model')
cli.add_argument('-t', '--to-bert4keras-ckpt', dest='to_bert4keras', type=str, help='to bert4keras ckpt-format model')
...
model_saved_path = args.from_keras  #'/disk/cw/nlp-guessing/models/passbert_model.ckpt'
...
grad_accum_steps = 1  # using gradiant accumulation when it is larger than 1
...
built_model.save_weights_as_checkpoint(args.to_bert4keras)