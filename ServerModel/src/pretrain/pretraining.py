...
cli.add_argument('--seq-len', default=512, type=int, help='sequence length')
cli.add_argument('--batch-size', default=32, type=int, help='batch size, note that batch_size=512 will raise OOM error')
args = cli.parse_args()
model = args.model
